...
function enterKey(e) {
    ...
    if (e.keyCode == 13) {
        ...
        git = commands.length;
        addLine("Joseph's Portfolio:~$ " + command.innerHTML, "no-animation", 0);
...
function router(cmd){
    switch (cmd.toLowerCase()) {
        ...
        case "email":
            addLine('Opening mailto:<a href="joseph.devasia1@outlook.com">joseph.devasia1@outlook.com</a>...', "color2", 80);
            openNewTab(email);
            break;
